...
import { parseCopy } from '../briefing/use-cases/copy-parser.js';
import { storyboardAgent } from '../briefing/use-cases/storyboard.agent.js';
import { avatarAgent } from '../media/image/avatar.agent.js';
import { animationAgent } from '../media/video/animation.agent.js';
import { audioAgent } from '../media/audio/audio.agent.js';
import { editorAgent } from '../assembly/editor.agent.js';
import driveUploader from '../../infrastructure/storage/drive-uploader.js';
import { logFase, atualizarStatus, buscarBriefing, listarLogs } from '../../infrastructure/database/dal.js';
